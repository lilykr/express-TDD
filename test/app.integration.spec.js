...
describe('Test routes', () => {
  ...
  it('POST / shows an incorrect url or title', (done) => {
    request(app)
      .post('/bookmarks')
      .send({})
      .expect(422)
  ...
  it('POST / all went well with the request', (done) => {
    request(app)
      .post('/bookmarks')
  ...
  describe('GET /bookmarks/:id', () => {
    ...
    it('GET / shows an incorrect id', (done) => {
      request(app)
        .get('/bookmarks/50')
        .expect(404)
        .then(response => {
    ...
    it('GET / all went well with the bookmark with id request', (done) => {
      request(app)
        .get('/bookmarks/1')
        .expect(200)
        .expect('Content-Type', /json/)
